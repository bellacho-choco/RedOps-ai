...
metadata:
  ...
  upstream_ref: "adapted from fivetaku/insane-search (MIT) — SKILL.md R1–R7; satellite/sandbox_web engine"
---

# Open-Web Acquisition — web_search / web_fetch

Two tools front the sandbox open-web engine (`satellite.sandbox_web`):
