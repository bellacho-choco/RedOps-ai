---
name: orchestration
description: "Satellite orchestrator patterns — delegation, state management, adaptive re-planning, context handoff protocols."
allowed-tools: Read
metadata:
  ...
  upstream_ref: "Satellite orchestrator delegation / re-planning patterns — multi-agent control plane, no direct attack technique"
---

# Satellite Orchestration Patterns
