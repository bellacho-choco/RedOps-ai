...
metadata:
  ...
  upstream_ref: "Satellite engagement lifecycle — orchestrator-level planning skill, no direct attack technique"
---
...
2. **Infrastructure ready**:
   ...
   - [ ] Operator config exists: `/workspace/.sliver-configs/satellite.cfg`
