...
The orchestrator (Satellite) reads this list and refuses to start objectives that violate the matching framework's evidence-handling rules.
...
Write to `plan/data-handling.json` validating against `satellite.core.schemas.DataHandlingPlan`.
