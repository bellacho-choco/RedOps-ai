...
- **ThreatProfile seed** — a valid `satellite.core.schemas.ThreatProfile` JSON (drop your
  `engagement_name`).
...
- **Emulate behavior, not malware.** Satellite reproduces an actor's *TTPs and sequencing*
