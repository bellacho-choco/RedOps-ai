...
metadata:
  ...
  tags: benchmark, ctf
  upstream_ref: "XBOW validation-benchmarks + Satellite CTF mode marker"
---
...
pacing live in their owning prompts/skills (see `satellite.md` Rules
...
this mapping lives. Generic agent prompts (`recon.md`, `exploit.md`, `satellite.md`)
...
**Consumer**: the orchestrator (`satellite.md`). When dispatching exploit, the orchestrator
