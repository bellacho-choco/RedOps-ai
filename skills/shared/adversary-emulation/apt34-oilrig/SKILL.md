---
name: apt34-oilrig
description: "Adversary-emulation profile for APT34 / OilRig (G0049), an Iranian state-sponsored espionage group, mapping its ATT&CK TTPs to Satellite tooling for authorized red-team emulation."
...
Map APT34's signature behaviors to Satellite capabilities to reproduce the actor's tradecraft for blue-cell exercise:
