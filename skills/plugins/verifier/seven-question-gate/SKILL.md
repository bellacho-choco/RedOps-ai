...
Check the engagement's `scope.md` (recon/satellite's RoE doc):
...
## Cross-references
- Verifier agent prompt: `satellite/agents/prompts/verifier.md`
- Verifier router: `skills/verifier/SKILL.md`
- Bounty report skill: `skills/verifier/bounty-report/SKILL.md`
- Operator's external `triage-validation` skill (Satellite-external) for the broader gate methodology
